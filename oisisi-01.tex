...
\begin{itemize}
  \item \myred{terminologija}: Python lista je zapravo niz
...
\begin{frame}[fragile]
  \frametitle{Rečnik}
  \begin{itemize}
    \item \myred{rečnik} (dictionary), za razliku od liste, ne poznaje redosled elemenata
    \item elementi rečnika nisu dostupni putem indeksa, već putem \myred{ključa}
    \item rečnik čuva \myred{parove ključ-vrednost}
  \end{itemize}
\begin{minted}[linenos=false,fontsize=\small]{python}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item ključ može biti bilo koji \myred{immutable} tip - broj, string, tuple
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Bruce Eckel vs Guido van Rossum: \\ \myred{Why explicit self has to stay} \\ \footnotesize
